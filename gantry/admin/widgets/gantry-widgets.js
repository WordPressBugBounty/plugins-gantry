...
var GantryWidgets = {
    ...
    overrideCheckboxes: function() {
        ...
        document.getElements('h2 > .override-checkbox, h3 > .override-checkbox').each(function(check) {
            ...
            var arrow = check.getParent('.sidebar-name').getElement('.sidebar-name-arrow') || check.getParent('.sidebar-name').getElement('button.handlediv');
